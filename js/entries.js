export default [
  // Each entry is define by the corresponding file name of the dema, the name
  // of the author and a link. The author name and the link are optional but
  // are an easy way to give back credits for the contribution. The link can be
